...
%>
	...
	<div id="main">
   		<div id="content">
   			<form id="searchForm" name="searchForm" action="change.jsp"  method="post">
				<input type="hidden" name="pageIndex" id="pageIndex"  value="1"></input>
			</form>
			<span class="titleStyle">请选择你要修改的记录:</span><br>
   			<table>
				<tr>
					<th width="10%">序号</th>
					<th width="60%">标题</th>
				...
				<tr>
					...
					<td><a href="change2.jsp?recordId=<%= r.getId() %>" target="_blank"><%= r.getTitle() %></a></td>
