...
<body>
	<%
		...
		}else{//如果为空，则重定向到修改页面。避免直接输入change2.jsp地址访问
	...
	<div id="main">
   		<div id="content">
				...
				<button class="button" onclick="startRequest();return false;">修改</button><br>
...
<script type="text/javascript">
    ...
    window.onload=function(){
    	document.getElementById("title").value="<%= selectR.getTitle() %>"
    	ue.addListener("ready", function () { 
    		//要等UEditor创建完成才能使用UEditor的setContent函数
    		ue.setContent(" <%= selectR.getContent() %>"); 
    		});
    }
  ...
  //创建XMLHttprequest 
	...
	function startRequest(){   
		    ...
		    //发送请求  
		    xmlhttp.send("action=change&id="+id
		    ...
		    if(xmlhttp.readyState==4){ 
		        if(xmlhttp.status==200){ 
		            ...
		            if(xmlhttp.responseText=="success"){ 
		            	document.getElementById("sMess").innerHTML="修改成功！";
		            }
		            else{
		            	document.getElementById("fMess").innerHTML="修改失败！";
		            }
		        }
		    }
		}
